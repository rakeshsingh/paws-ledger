...
7. As a visitor, if I am able to find that the microchip is reisgered to the portal, I should get an option to register to the website
...
14. When a physical QR/NFC tag is scanned by anyone, the system should resolve the tag code to the pet's public profile and log the scan event, and scan location
